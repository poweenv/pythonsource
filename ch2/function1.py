...
# 기본값 : ㅜ =2 => 함수 호출 시 값이 넘어오지 않는다면 기본값을 2로 지정
...
add_result = sum_mul("mul",1,2,3,4,5,6)
...
example_mul(10,20,"park","kim",age=25, name="aho")
...
import random
print("임의의 수",random.randrange(1,42))
